local SongliaoWarResultTemplate = Class(game.UITemplate)

function SongliaoWarResultTemplate:_init(ctrl)

end

function SongliaoWarResultTemplate:OpenViewCallBack()

end

function SongliaoWarResultTemplate:RefreshItem(idx)
...
return SongliaoWarResultTemplate